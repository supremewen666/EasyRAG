...
class ProviderAdapterTestCase(unittest.TestCase):
    ...
    def test_dashscope_vl_embedding_uses_official_endpoint(self) -> None:
        ...
        os.environ["EASYRAG_EMBEDDING_BASE_URL"] = "https://dashscope.aliyuncs.com/compatible-mode/v1"
        fake_httpx = _FakeHTTPX({"output": {"embeddings": [{"embedding": [1.0, 2.0]}, {"embedding": [3.0, 4.0]}]}})
    ...
    def test_dashscope_intl_text_rerank_uses_compatible_endpoint(self) -> None:
        ...
        os.environ["EASYRAG_RERANK_BASE_URL"] = "https://dashscope-intl.aliyuncs.com/compatible-mode/v1"
